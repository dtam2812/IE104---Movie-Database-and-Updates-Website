  ...
  async function fetchTvDetails(tvId) {
    try {
      ...
      const rating = contentRatings.find(r => r.iso_3166_1 === "US") 
                  || contentRatings.find(r => r.iso_3166_1 === "GB")
                  || contentRatings[0];
      
      const ageRatingElement = document.querySelector(".movie-content-age span strong");
