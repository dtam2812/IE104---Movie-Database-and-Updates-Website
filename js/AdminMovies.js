...
export function AdminMovies_js() {  
    ...
    function filterMovies() {
        ...
        filteredMovies = allMovies.filter(movie => {
            ...
            const matchCountry = countryValue === 'all' || movie.country === countryValue;
    ...
    function createMovieRow(movie, no) {
        ...
        durationCell.textContent = movie.duration > 0 ? `${movie.duration} min` : 'N/A';
        newRow.appendChild(durationCell);

        const ratingCell = document.createElement('td');
        ratingCell.innerHTML = movie.rating > 0 
    ...
    function openEditModal(row) {
        ...
        movieFormEl.querySelector('textarea[name="overview"]').value = movie.overview || '';
        movieFormEl.querySelector('input[name="genre"]').value = movie.genre;
        movieFormEl.querySelector('input[name="duration"]').value = movie.duration || '';
        movieFormEl.querySelector('input[name="country"]').value = movie.country;
        movieFormEl.querySelector('input[name="director"]').value = movie.director || '';
        movieFormEl.querySelector('input[name="actors"]').value = movie.actors || '';
        movieFormEl.querySelector('input[name="producer"]').value = movie.producer || '';
        movieFormEl.querySelector('input[name="budget"]').value = movie.budget || '';
        movieFormEl.querySelector('input[name="revenue"]').value = movie.revenue || '';
        movieFormEl.querySelector('input[name="trailer"]').value = movie.trailer || '';
        movieFormEl.querySelector('input[name="rating"]').value = movie.rating || '';
    ...
    movieFormEl.addEventListener('submit', function(event) {
        ...
        const overview = movieFormEl.querySelector('textarea[name="overview"]').value;
        const genre = movieFormEl.querySelector('input[name="genre"]').value;
        const duration = parseInt(movieFormEl.querySelector('input[name="duration"]').value) || 0;
        ...
        const budget = parseInt(movieFormEl.querySelector('input[name="budget"]').value) || 0;
        const revenue = parseInt(movieFormEl.querySelector('input[name="revenue"]').value) || 0;
        const trailer = movieFormEl.querySelector('input[name="trailer"]').value || '';
        const rating = parseFloat(movieFormEl.querySelector('input[name="rating"]').value) || 0;
