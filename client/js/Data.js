...
export const moviesData = [
  {
    ...
    title: "Spirited Away",
    overview:
      "A young girl named Chihiro becomes trapped in a mysterious world of spirits and must find a way to free herself and her parents.",
  ...
  },
  {
    ...
    title: "Parasite",
    overview:
      "A poor family cunningly infiltrates a wealthy household, leading to unexpected consequences and a sharp critique of social inequality.",
  ...
  },
  {
    ...
    overview:
      "Batman faces his greatest psychological and moral challenge when he confronts the chaotic criminal mastermind known as the Joker.",
    genre: "Action, Crime",
    duration: 152,
    country: "America",
  ...
  },
  {
    ...
    title: "Your Name",
    overview:
      "Two high school students mysteriously start switching bodies, creating an emotional and time-twisting journey of love and destiny.",
  ...
  },
  {
    ...
    overview:
      "A group of passengers on a train must fight for survival when a zombie outbreak sweeps across South Korea.",
    genre: "Horror, Action",
    duration: 118,
    country: "Korea",
  ...
  },
  {
    ...
    title: "Avatar 3",
    overview:
      "The next chapter in James Cameron s epic saga expands the world of Pandora and explores new clans and uncharted territories.",
    ...
    seasonsData: [
      {
        ...
        episodes: 7,
        overview:
          "Walter White, a struggling high school chemistry teacher, is diagnosed with lung cancer.",
        poster: "/public/assets/image/movie_poster_default.jpg",
      },
      {
        title: "Season 2",
